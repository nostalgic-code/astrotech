              ...
              <div className="mx-auto max-w-7xl px-6">
                <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                  <AnimatedGroup variants={transitionVariants}>
                    ...
                    >
                      <span className="text-foreground text-sm">Unlock AI-Driven Workflow Automation</span>
                  ...
                  <TextEffect
                    ...
                    speedSegment={0.3}
                    as="h1"
                    className="mt-8 text-balance text-6xl md:text-7xl lg:mt-16 xl:text-[5rem]"
                  >
                    Your Business, Supercharged with AI & Smart Tech
                  </TextEffect>
                  <TextEffect
                    per="line"
                    preset="fade-in-blur"
                  ...
                  >
                    We build intelligent AI agents, streamlined workflows, stunning websites, 
                    and provide reliable IT solutions — so you can focus on growing your business, not managing tech.
                  </TextEffect>
